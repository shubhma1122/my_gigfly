...
class CheckoutComponent extends Component
{
    ...
    public function mount($id)
    {
        ...
        // Set total amount
        $this->total        = convertToNumber($subscription->amount);
    }
                ...
                switch ($this->selected_method) {
                    ...
                    case 'mollie':
                        ...
                        $payment  = $mollie->payments->create([
                            ...
                            "redirectUrl" => url("callback/mollie?action=B"),
                    ...
                    case 'xendit':
                        ...
                        $params = [ 
                            ...
                            'success_redirect_url' => url('callback/xendit/success?action=B'),
    ...
    public function offline()
    {
        try {
            ...
            $this->subscription->payment_id     = "BB" . uid(17);
