                ...
                <div class="col-span-12">
                    ...
                    <div class="w-full" wire:ignore>
                        <x-bladewind.select required searchable
                            ...
                            @php
                                $paytabs_currencies = [ 'AED', 'EGP', 'SAR', 'OMR', 'JOD', 'US' ];
                            @endphp
                            @foreach ($paytabs_currencies as $currency)
                                <x-bladewind.select-item :label="$currency" :value="$currency" />
                            @endforeach
                ...
                <div class="col-span-12">
                    ...
                    <div class="w-full" wire:ignore>
                        <x-bladewind.select required searchable
                            ...
                            @foreach ([ 'ARE', 'EGY', 'SAU', 'OMN', 'JOR', 'GLOBAL' ] as $reg)
                                <x-bladewind.select-item :label="$reg" :value="$reg" />
                            @endforeach
                    ...
                    {{-- Error --}}  
                    @error('region')
                        <p class="mt-1 text-xs text-red-600 dark:text-red-500">{{ $errors->first('region') }}</p>
                    @enderror 
