<div class="w-full">
    ...
    <div class="lg:flex lg:items-center lg:justify-between mb-14">
        ...
        <div class="mt-5 flex lg:mt-0 lg:ltr::ml-4 lg:rtl:mr-4 justify-between">
            ...
            {{-- Create --}}
            <a href="{{ admin_url('subcategories/create') }}" class="btn p-2.5 hover:shadow-none ring-slate-300 dark:ring-zinc-600 focus:ring-offset-2 focus:ring-offset-slate-300 dark:focus:ring-offset-zinc-600 space-x-2 rtl:space-x-reverse border">
                            ...
                            <td class="table-report__action">
                                <div class="flex items-center justify-center space-x-2 rtl:space-x-reverse">
                                    ...
                                    <x-table.action-button 
                                        ...
                                        href="{{ admin_url('subcategories/delete/' . $subcategory->uid) }}" />
