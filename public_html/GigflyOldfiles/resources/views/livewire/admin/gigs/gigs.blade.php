<div class="w-full" x-data="window.YQWkBYIRBPsBRXD">
    ...
    <div class="lg:flex lg:items-center lg:justify-between mb-14">
        ...
        <div class="mt-5 flex lg:mt-0 lg:ltr::ml-4 lg:rtl:mr-4 justify-between">
            ...
            {{-- Deleted gigs --}}
            <a href="{{ admin_url('gigs/trash') }}" class="btn p-2.5 hover:shadow-none ring-slate-300 dark:ring-zinc-600 focus:ring-offset-2 focus:ring-offset-slate-300 dark:focus:ring-offset-zinc-600 space-x-2 rtl:space-x-reverse border">
                <x-icon class="w-6 h-6 text-gray-400 dark:text-zinc-300" name="trash" variant="solid" mini />
            </a>
            ...
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        ...
                        {{-- Gig --}}
                        <th>@lang('messages.t_gig')</th>

                        {{-- Price --}}
                        <th class="text-center">@lang('messages.t_price')</th>

                        {{-- Visits --}}
                        <th class="text-center">@lang('messages.t_visits')</th>

                        {{-- Sales --}}
                        <th class="text-center">@lang('messages.t_sales')</th>

                        {{-- In_queue --}}
                        <th class="text-center">@lang('messages.t_in_queue')</th>

                        {{-- Rating --}}
                        <th class="text-center">@lang('messages.t_rating')</th>
                    ...
                    @forelse ($gigs as $gig)
                        ...
                        <tr wire:key="gigs-{{ $gig->uid }}">
                                ...
                                <div class="flex items-center space-x-4 rtl:space-x-reverse">
                                    ...
                                    <div class="space-y-1 font-medium dark:text-white">
                                        <div class="flex items-center space-x-1 rtl:space-x-reverse">
                                            <a href="{{ url('service', $gig->slug) }}" target="_blank" class="font-semibold whitespace-nowrap truncate block max-w-[240px] hover:text-zinc-900 dark:text-white text-sm text-zinc-700" title="{{ $gig->username }}">
                                                {{ $gig->title }}
                                            </a>
                                        </div>
                                        <div class="flex items-center space-x-2 rtl:space-x-reverse text-xs font-normal text-gray-400 dark:text-zinc-300">
                                            ...
                                            @if ($gig->childcategory)
                                                ...
                                                {{-- Childcategory --}}
                                                <a href="{{ url('categories/' . $gig->category->slug . '/' . $gig->subcategory->slug . '/' . $gig->childcategory?->name) }}" target="_blank" class="dark:text-zinc-300 whitespace-nowrap hover:text-gray-600 hover:underline">
                                                    {{ $gig->childcategory?->name }}   
                                                </a>
                            ...
                            <td class="text-center">
                                <div class="text-gray-900 dark:text-gray-100 text-sm font-semibold">{{ money($gig->price, settings('currency')->code, true) }}</div>
                            </td>
                            ...
                            <td class="text-center table-report__action">
                                <div class="flex justify-center items-center space-x-2 rtl:space-x-reverse">
                                    ...
                                    <x-table.action-button 
                                        ...
                                        href="{{ admin_url('gigs/edit/' . $gig->uid) }}" />
