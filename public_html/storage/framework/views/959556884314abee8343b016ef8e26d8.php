    ...
    <div class="lg:flex lg:items-center lg:justify-between mb-14">
        ...
        <div class="min-w-0 flex-1">
            ...
            <h2 class="text-lg font-bold leading-7 text-zinc-700 dark:text-gray-50 sm:truncate sm:text-xl sm:tracking-tight">
                <?php echo app('translator')->get('messages.t_pages'); ?>
            </h2>
        ...
        <div class="mt-5 flex lg:mt-0 lg:ltr::ml-4 lg:rtl:mr-4 justify-between">
            ...
            <a href="<?php echo e(admin_url('pages/create'), false); ?>" class="btn p-2.5 hover:shadow-none ring-slate-300 dark:ring-zinc-600 focus:ring-offset-2 focus:ring-offset-slate-300 dark:focus:ring-offset-zinc-600 space-x-2 rtl:space-x-reverse border">
            ...
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        ...
                        <th><?php echo app('translator')->get('messages.t_title'); ?></th>
                        <th><?php echo app('translator')->get('messages.t_slug'); ?></th>
                        <th class="text-center"><?php echo app('translator')->get('dashboard.t_type'); ?></th>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr wire:key="pages-<?php echo e($page->uid, false); ?>">
                            ...
                            <td class="text-center">
                                ...
                                <?php if($page->is_link && $page->link): ?>
                                    <span class="bg-blue-100 text-blue-600 px-4 inline-block py-1.5 rounded-3xl font-semibold text-[11px] tracking-wide whitespace-nowrap">
                                        <?php echo app('translator')->get('messages.t_link'); ?>
                                    </span>
                                <?php endif; ?>
                                ...
                                <?php if(!$page->is_link && !$page->link): ?>
                                    <span class="bg-gray-100 text-gray-600 px-4 inline-block py-1.5 rounded-3xl font-semibold text-[11px] tracking-wide whitespace-nowrap">
                                        <?php echo app('translator')->get('dashboard.t_page'); ?>
                                    </span>
                                <?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table.action-button','data' => ['target' => '_blank','icon' => 'eye','title' => __('messages.t_view'),'href' => ''.e($page->is_link ? $page->link : url('page', $page->slug), false).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['target' => '_blank','icon' => 'eye','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_view')),'href' => ''.e($page->is_link ? $page->link : url('page', $page->slug), false).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                    ...
                                    <?php if (isset($component)) { $__componentOriginal25db5b2b4ed745b6b0fe0dc3034b2fb4 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal25db5b2b4ed745b6b0fe0dc3034b2fb4 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table.action-button','data' => ['icon' => 'pencil','title' => __('messages.t_edit'),'href' => ''.e(admin_url('pages/edit/' . $page->uid), false).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('table.action-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'pencil','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_edit')),'href' => ''.e(admin_url('pages/edit/' . $page->uid), false).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal25db5b2b4ed745b6b0fe0dc3034b2fb4)): ?>
<?php $attributes = $__attributesOriginal25db5b2b4ed745b6b0fe0dc3034b2fb4; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:confirm' => ''.e(__('messages.t_are_u_sure_u_want_to_delete_this'), false).'','icon' => 'trash','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('messages.t_delete')),'icon-color' => 'text-red-600','action' => 'delete(\''.e($page->id, false).'\')']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal25db5b2b4ed745b6b0fe0dc3034b2fb4)): ?>
<?php $attributes = $__attributesOriginal25db5b2b4ed745b6b0fe0dc3034b2fb4; ?>
                        ...
                        <tr>
                            <td colspan="5">
                                <div class="text-center px-4 bw-empty-state py-10">
                                    ...
                                    <a href="<?php echo e(admin_url('pages/create'), false); ?>" class="bw-button primary !bg-primary-600 focus:ring-primary-500/70 hover:!bg-primary-700 active:!bg-primary-700 focus:!ring cursor-pointer rounded-full inline-block mx-auto my-4 !px-10 !font-normal !text-[11px] !py-2.5 tracking-widest uppercase dark:focus:ring-offset-0 dark:focus:ring-offset-transparent">
...
</div><?php /**PATH /home/u304230485/domains/gigfly.in/public_html/resources/views/livewire/admin/pages/pages.blade.php ENDPATH**/ ?>