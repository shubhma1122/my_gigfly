...
} elseif ($_instance->childHasBeenRendered('c6ymwf8')) {
    $componentId = $_instance->getRenderedChildComponentId('c6ymwf8');
    $componentTag = $_instance->getRenderedChildComponentTagName('c6ymwf8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('c6ymwf8');
} else {
    $response = \Livewire\Livewire::mount('main.partials.languages');
    $html = $response->html();
    $_instance->logRenderedChild('c6ymwf8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                 <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('mHoBFmY')) {
    $componentId = $_instance->getRenderedChildComponentId('mHoBFmY');
    $componentTag = $_instance->getRenderedChildComponentTagName('mHoBFmY');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('mHoBFmY');
} else {
    $response = \Livewire\Livewire::mount('main.partials.search');
    $html = $response->html();
    $_instance->logRenderedChild('mHoBFmY', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('TjmP81a')) {
    $componentId = $_instance->getRenderedChildComponentId('TjmP81a');
    $componentTag = $_instance->getRenderedChildComponentTagName('TjmP81a');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('TjmP81a');
} else {
    $response = \Livewire\Livewire::mount('main.partials.cart');
    $html = $response->html();
    $_instance->logRenderedChild('TjmP81a', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
 ...
 <?php $__env->stopPush(); ?>
 <?php /**PATH /home/u344139974/domains/gigfly.in/public_html/OLDGigfly/resources/views/livewire/main/includes/header.blade.php ENDPATH**/ ?>