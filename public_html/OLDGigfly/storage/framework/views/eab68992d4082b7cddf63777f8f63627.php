...
} elseif ($_instance->childHasBeenRendered('O8qxnYK')) {
    $componentId = $_instance->getRenderedChildComponentId('O8qxnYK');
    $componentTag = $_instance->getRenderedChildComponentTagName('O8qxnYK');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('O8qxnYK');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('O8qxnYK', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('accbqdk')) {
    $componentId = $_instance->getRenderedChildComponentId('accbqdk');
    $componentTag = $_instance->getRenderedChildComponentTagName('accbqdk');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('accbqdk');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('accbqdk', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/u344139974/domains/gigfly.in/public_html/OLDGigfly/resources/views/livewire/admin/layout/app.blade.php ENDPATH**/ ?>