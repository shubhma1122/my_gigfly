...
} elseif ($_instance->childHasBeenRendered('F4BLT8K')) {
    $componentId = $_instance->getRenderedChildComponentId('F4BLT8K');
    $componentTag = $_instance->getRenderedChildComponentTagName('F4BLT8K');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('F4BLT8K');
} else {
    $response = \Livewire\Livewire::mount('main.cards.gig', ['gig' => $item->gig]);
    $html = $response->html();
    $_instance->logRenderedChild('F4BLT8K', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/u344139974/domains/gigfly.in/public_html/OLDGigfly/resources/views/livewire/main/account/reviews/options/create.blade.php ENDPATH**/ ?>