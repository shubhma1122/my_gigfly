    ...
    static function validate($request)
    {
        try {
            ...
            $rules    = [
                ...
                'logo'                 => 'nullable|image|mimes:jpg,png,jpeg,svg,webp,gif',
                'logo_dark'            => 'nullable|image|mimes:jpg,png,jpeg,svg,webp,gif',
                'logo_transparent'     => 'nullable|image|mimes:jpg,png,jpeg,svg,webp,gif',
                'favicon'              => 'nullable|image|mimes:jpg,png,jpeg,svg,webp,gif',
            ...
            $messages = [
                ...
                'logo_transparent.image'       => __('messages.t_validator_image'),
                'logo_transparent.mimes'       => __('messages.t_validator_mimes'),
            ...
            $data     = [
                ...
                'logo_transparent'     => $request->logo_transparent,
