    ...
    static function validate($request)
    {
        try {
            ...
            $rules    = [
                ...
                'default_buyer_level'          => ['required', Rule::exists('levels', 'id')->where('account_type', 'buyer')],
                'default_seller_level'         => ['required', Rule::exists('levels', 'id')->where('account_type', 'seller')],
            ];
            ...
            $messages = [
                ...
                'default_buyer_level.required'          => __('messages.t_validator_required'),
                'default_buyer_level.exists'            => __('messages.t_validator_exists'),
                'default_seller_level.required'         => __('messages.t_validator_required'),
            ...
            $data     = [
                ...
                'default_buyer_level'          => $request->default_buyer_level,
                'default_seller_level'         => $request->default_seller_level,
            ];
