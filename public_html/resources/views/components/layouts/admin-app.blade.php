                ...
                <div class="h-16 flex-none flex items-center justify-between lg:justify-center px-4 w-full">
                    ...
                    @if (current_theme() == 'dark' && settings('general')->logo_dark)
                        <a href="{{ admin_url('/') }}" class="block">
                            <img width="150" height="{{ $logo_height }}" src="{{ $logo_dark }}" alt="{{ $site_title }}" style="height:{{ $logo_height }}px;width:auto">
                        </a>
                    @else
                        <a href="{{ admin_url('/') }}" class="block">
                            <img width="150" height="{{ $logo_height }}" src="{{ src(settings('general')->logo) }}" alt="{{ $site_title }}" style="height:{{ $logo_height }}px;width:auto">
                        </a>
                    @endif
            ...
            <header x-bind:class="{
                ...
                <div class="flex justify-between max-w-10xl mx-auto px-4 lg:px-8 w-full">
                    ...
                    <div class="flex items-center space-x-2 rtl:space-x-reverse">
                        ...
                        {{-- Search --}}
                        {{-- <div class="hidden sm:block"><form onsubmit="return!1"><input type="text" class="w-full block border border-gray-200 rounded px-3 py-2 leading-5 text-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" id="tk-form-layouts-search" placeholder="Search.."></form></div><div class="sm:hidden"><button type="button" class="inline-flex justify-center items-center space-x-2 border font-semibold focus:outline-none px-3 py-2 leading-5 text-sm rounded border-gray-300 bg-white text-gray-800 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none"><svg class="hi-solid hi-search inline-block w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clip-rule="evenodd"/></svg></button></div> --}}
                    ...
                    <div class="flex items-center space-x-2 rtl:space-x-reverse">
                        ...
                        <button type="button" class=" relative inline-flex justify-center items-center space-x-2 border font-semibold focus:outline-none px-3 py-2 leading-5 text-sm rounded border-gray-300 bg-white text-gray-700 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none dark:bg-zinc-700 dark:border-zinc-600 dark:text-zinc-300 dark:hover:bg-zinc-800" data-drawer-target="notifications-drawer" data-drawer-show="notifications-drawer" aria-controls="notifications-drawer" data-drawer-placement="right" data-drawer-backdrop="false">
                            ...
                            @if (isset($notifications['total']) && (int)$notifications['total'] > 0)
                                ...
                                <div class="bg-white ring-1 ring-black ring-opacity-5 rounded divide-y divide-gray-100 dark:bg-zinc-900 dark:divide-zinc-800">
                                    <div class="p-2 space-y-1">
                                        ...
                                        <a href="{{ admin_url('profile') }}" class="flex items-center space-x-2 rtl:space-x-reverse rounded py-2 px-3 text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-700 focus:outline-none focus:bg-gray-100 focus:text-gray-700 dark:text-zinc-300 dark:hover:bg-zinc-700 dark:focus:bg-zinc-800 dark:focus:text-zinc-200">
                                            ...
                                            <span>@lang('messages.t_edit_profile')</span>
                                        </a>

                                        {{-- Go to homepage --}}
                                        <a href="{{ url('/') }}" target="_blank" class="flex items-center space-x-2 rtl:space-x-reverse rounded py-2 px-3 text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-700 focus:outline-none focus:bg-gray-100 focus:text-gray-700 dark:text-zinc-300 dark:hover:bg-zinc-700 dark:focus:bg-zinc-800 dark:focus:text-zinc-200">
                                            ...
                                            <span>@lang('messages.t_go_homepage')</span>
                                        </a>
                                    ...
                                    <div class="p-2 space-y-1">
                                        ...
                                        {{-- Logout --}}
                                        <a href="{{ admin_url('logout') }}" target="_blank" class="flex items-center space-x-2 rtl:space-x-reverse rounded py-2 px-3 text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-700 focus:outline-none focus:bg-gray-100 focus:text-gray-700 dark:text-zinc-300 dark:hover:bg-zinc-700 dark:focus:bg-zinc-800 dark:focus:text-zinc-200">
                                            ...
                                            <span>@lang('messages.t_logout')</span>
                                        </a>
            ...
            <footer id="page-footer" class="flex flex-none items-center bg-white border-t dark:bg-zinc-900 dark:border-zinc-700">
                <div class="text-center flex flex-col md:ltr:text-left md:rtl:text-right md:flex-row md:justify-between text-xs text-gray-500 dark:text-zinc-400 max-w-10xl mx-auto px-4 lg:px-8 w-full font-semibold">
                    ...
                    <div class="pb-4 pt-1 md:pt-4 inline-flex items-center justify-center">
                        {{ config('app.name') }} {{ config('global.version') }}
                    </div>
                </div>
            </footer>
