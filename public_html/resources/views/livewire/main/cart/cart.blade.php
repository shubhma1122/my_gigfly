                                            ...
                                            <div class="ltr:ml-0 rtl:mr-0 flex-1 flex flex-col justify-between ltr:sm:ml-6 rtl:sm:mr-6">
                                                <div class="relative ltr:pr-9 rtl:pl-9 sm:grid sm:grid-cols-2 sm:gap-x-6 ltr:sm:pr-0 rtl:sm:pl-0">
                                                    ...
                                                    <div class="mt-4 sm:mt-0 sm:pr-9 text-center">
                                                        ...
                                                        <select id="shopping-cart-quantity-id-{{ $key }}" wire:model.live="cart.{{ $key }}.quantity" class="max-w-full rounded-md border border-gray-300 py-1.5 text-base leading-5 font-medium text-gray-700 text-left shadow-sm focus:outline-none focus:ring-1 focus:ring-primary-600 focus:border-primary-600 sm:text-sm">
